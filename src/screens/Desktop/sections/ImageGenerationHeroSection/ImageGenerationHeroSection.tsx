        ...
        <CardContent className="px-[87px] py-8">
          <div className="max-w-2xl w-full mx-auto flex flex-col gap-8">
            ...
            <div className="flex flex-col items-center gap-6">
              ...
              {generatedImage && (
                <div className="w-full mt-4 flex flex-col items-center animate-in fade-in slide-in-from-top-4 duration-500">
                  <img
                    src={generatedImage}
                    alt="Generated by AI"
                    className="rounded-xl shadow-lg max-w-full h-auto"
                  />
                  <p className="mt-4 text-sm text-gray-500 font-medium">Generated with Gemini Nano Banana</p>
                </div>
              )}
            </div>
          </div>
