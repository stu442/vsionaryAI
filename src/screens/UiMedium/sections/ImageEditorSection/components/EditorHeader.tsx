    ...
    <header className="flex flex-col px-6 py-4 bg-white border-b">
      <div className="flex items-center justify-between w-full">
        <div className="flex items-center gap-4">
                              <h1 className="text-lg font-normal text-gray-900 truncate max-w-[400px] [font-family:'Inter',Helvetica]">
                                  {title}
                              </h1>          <Badge className="bg-amber-100 text-amber-700 hover:bg-amber-100 h-auto px-2.5 py-1 rounded-full">
